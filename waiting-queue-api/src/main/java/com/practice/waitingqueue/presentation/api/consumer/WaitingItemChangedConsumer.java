package com.practice.waitingqueue.presentation.api.consumer;

import com.practice.waitingqueue.domain.service.WaitingItemSyncService;
import com.practice.waitingqueue.presentation.api.dto.WaitingItemChangedMessage;
 ...
 * 해당 예제 프로젝트에는 실제로 카프카 메시지를 발행하지 않으니 예시 코드로 동작만 작동해두었습니다.
 * 실제 프로젝트에서는 대기열 관련 상품의 제어가 필요하다면 @KafkaListener 어노테이션을 사용하여 카프카 메시지를 수신하여 사용하면 됩니다.
 */
@Slf4j
@Component
...
public class WaitingItemChangedConsumer {
     ...
     * itemId가 메시지키로 사용되므로 상품별 순차처리가 보장됩니다.
     */
