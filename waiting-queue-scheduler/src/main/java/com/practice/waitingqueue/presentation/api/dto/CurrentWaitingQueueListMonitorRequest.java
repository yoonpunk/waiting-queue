...
@Schema(description = "현재 대기열의 토큰 수 모니터링을 위한 요청 DTO")
public class CurrentWaitingQueueListMonitorRequest {
    ...
    public WaitingQueueMonitoringCriteria toWaitingQueueMonitoringCriteria() {
        if (searchAll) {
            return WaitingQueueMonitoringCriteria.createForSearchAll();
        }
        return WaitingQueueMonitoringCriteria.createForSearchPartial(itemIdListToSearch);
    }
}
